...
public class Diposit<T> {
	 ...
	 * @param preu el preu de la beguda en cèntims
	 */
	public Diposit(String beguda, int preu) {
		nom = beguda;
		valor = preu;
		capacitatDiposit = CAPACITATDIPOSITDEFECTE;
		contingut = new ArrayList<T>();        
	 ...
	 * @param preu Preu de cada beguda en cèntims
	 * @param capacitat capacitat del dipòsit
	 * @param b llista de begudes que ja estan a lloc
	 */
	public Diposit(String beguda, int  preu, int capacitat, 
			ArrayList<T> b) {
		contingut = b;
		nom = beguda;
		valor = preu;
	...
	/**
	 * @return el preu de la beguda en centims
	 */
	public int getValor() {
		return valor;
	}
	...
	/**
	 * @param valor el preu de la beguda a posar en centims.
	 */
